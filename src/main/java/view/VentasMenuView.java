...
public class VentasMenuView extends JFrame {
    ...
    public VentasMenuView() {
        ...
        // 🔥 CORREGIDO: Se elimina la lógica de apertura duplicada de aquí.
        // Ahora los eventos son escuchados únicamente por el Controlador.
    }
    ...
    private void inicializarComponentes() {
        JLabel titulo = new JLabel("Módulo de Ventas", JLabel.CENTER);
        ...
        btnClientes = crearBoton("Clientes", new Color(0, 102, 204));
        btnServicios = crearBoton("Servicios", new Color(102, 51, 153));
        btnOrdenServicio = crearBoton("Crear Orden Servicio", new Color(0, 153, 76));
        btnOrdenesServicio = crearBoton("Órdenes Servicio", new Color(0, 153, 153));
        btnSalidaAlmacen = crearBoton("Salida Almacén", new Color(204, 153, 0));
        btnFacturaVenta = crearBoton("Factura Venta", new Color(153, 0, 153));
    ...
    public JButton getBtnOrdenServicio() { return btnOrdenServicio; }
    public JButton getBtnOrdenesServicio() { return btnOrdenesServicio; }
    public JButton getBtnSalidaAlmacen() { return btnSalidaAlmacen; }
    public JButton getBtnFacturaVenta() { return btnFacturaVenta; }
}