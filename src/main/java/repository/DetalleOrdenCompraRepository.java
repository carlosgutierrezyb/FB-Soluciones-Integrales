...
public class DetalleOrdenCompraRepository {
    ...
    public boolean insertarLista(
        ...
        String sql =
                "INSERT INTO detalle_orden "
                        + "(id_orden, id_item, cantidad_pedida) "
                        + "VALUES (?, ?, ?)";
    ...
    // 🔹 LISTAR POR ORDEN
    // =========================
    public List<DetalleOrdenCompra> listarPorOrden(
            int idOrden
    ) {
    ...
    // =========================
    public DetalleOrdenCompra obtenerPorOrdenYItem(
            int idOrden,
            int idItem
    ) {
    ...
    public boolean actualizarCantidad(
        ...
        try (
            ...
            System.out.println(
                    "✏️ Cantidad actualizada correctamente."
            );
    ...
    public boolean eliminarItem(
        ...
        try (
            ...
            System.out.println(
                    "🗑️ Ítem eliminado correctamente."
            );
    ...
    public int obtenerTotalPedido(
        ...
        String sql =
                "SELECT COALESCE(SUM(cantidad_pedida), 0) AS total "
                        + "FROM detalle_orden "
                        + "WHERE id_orden = ?";
